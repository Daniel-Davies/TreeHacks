...
def upload(request):
    ...
    return render(request, 'DocOc/verdict.html',{'result': result,'x_scatter_data': results_bacteria,'y_scatter_data':results_viral,'z_scatter_data':results_demo,'heatmap_data':flatmap_vals})
